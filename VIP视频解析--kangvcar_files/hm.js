(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "583bbe764443069261e2e35e8b2b8ac8",
        dm: ["cosdao.com"],
            ...
            _trackRTEvent: function(a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m)
                        ...
                        for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.R).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++)
                            l.push(v),
    ...
    (function() {
        ...
        a.prototype = {
            ...
            ta: function() {
                ...
                var a = u;
                this.A(document.referrer) && this.A(document.location.href) ? a = r : (a = b.K(document.referrer),
                a = this.P(a || "", document.location.hostname));
            ...
            ga: function() {
                ...
                a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * k.R),
